...
public class EditPaintingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_painting);
        ...
        btnStatusChange.setOnClickListener(v -> {
            ...
            if (isCompleted) {
                db.updatePaintingStatus(requestId, "в работе");
                Toast.makeText(this, "Покраска возвращена в работу!", Toast.LENGTH_SHORT).show();
            } else {
                db.updatePaintingStatus(requestId, "выполнено");
                Toast.makeText(this, "Покраска выполнена!", Toast.LENGTH_SHORT).show();
            }
            finish();
        });
        ...
        btnDelete.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Да, удалить", (dialog, which) -> {
                        db.deletePaintingRequest(requestId);
    ...
    private void updateData() {
        ...
        updatedRequest.put("color", etColor.getText().toString());
        updatedRequest.put("date", etDate.getText().toString());
        updatedRequest.put("time", etTime.getText().toString());

        db.updatePaintingRequest(requestId, updatedRequest);
